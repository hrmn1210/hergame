...
<footer class="page-footer font-small pt-4 mt-5">
    <div class="container">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <!-- Links -->
                    <h5 class="text-uppercase footer-text">Tentang Kami</h5>
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center small py-3">© 2024 Copyright :
            <a href="syauqizaidan.github.io" class="text-white"> Descienfy / Herman Firmansyah</a>
        </div>
    </div>
    <!-- Copyright -->
