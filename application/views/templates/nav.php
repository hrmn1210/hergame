        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="topup" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Topup
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" style="color:#d6011d !important;"
                                href="https://www.codashop.com/id-id/mobile-legends">Mobile Legends</a>
                            <a class="dropdown-item" style="color:#d6011d !important;" href="
                            https://www.codashop.com/id-id/free-fire">Free Fire</a>
                            <a class="dropdown-item" style="color:#d6011d !important;" href="
                            https://www.codashop.com/id-id/arena-of-valor">Arena of valor</a>
                            <a class="dropdown-item" style="color:#d6011d !important;" href="
                            https://www.codashop.com/id-id/pubg-mobile-uc-redeem-code">PUBG</a>
                            <a class="dropdown-item" style="color:#d6011d !important;" href="
                            https://www.codashop.com/id-id/marvel-duel">Marvel Super Wars</a>
                        </div>
                    </li>
